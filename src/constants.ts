...
export const MIN_LOCAL_FILE_SIZE_MB = 1;
export const MAX_LOCAL_FILE_SIZE_MB = 200;
export const DEFAULT_REMOTE_CONVERSION_TIMEOUT_MS = 15000;
export const MIN_REMOTE_CONVERSION_TIMEOUT_MS = 1000;
export const MAX_REMOTE_CONVERSION_TIMEOUT_MS = 120000;
export const DEFAULT_SYNCFUSION_SERVICE_URL = 'http://localhost:62869/api/documenteditor/';
