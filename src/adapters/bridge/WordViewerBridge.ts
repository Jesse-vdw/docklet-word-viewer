import { createBridgeId, formatSandbox } from '../../services/shared/iframeBridge.ts';
import { BRIDGE_CHANNEL, BRIDGE_READY_TIMEOUT_MS, CSS_IFRAME } from '../../domain/constants.ts';
...
import { buildWordViewerHtml } from '../../ui/views/WordViewerHost.ts';
