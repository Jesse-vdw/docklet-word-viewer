...
export interface WordDocumentNote {
	id: string;
	blocks: WordBlock[];
	plainText: string;
}
export interface WordDocumentComment extends WordDocumentNote {
	author: string | null;
	date: string | null;
}
...
export interface WordParagraphFormat {
	marginBeforePt: number | null;
	marginAfterPt: number | null;
	indentLeftPt: number | null;
	indentHangingPt: number | null;
...
export interface WordPageBreakBlock {
	type: 'pageBreak';
	id: string;
}
...
export interface WordBreakInline {
	type: 'break';
}
export interface WordPageBreakInline {
	type: 'pageBreak';
}
export interface WordImageInline {
	type: 'image';
	src: string;
	altText: string;
	widthPx: number | null;
...
export interface WordNoteReferenceInline {
	type: 'noteReference';
	noteType: 'footnote' | 'endnote';
	noteId: string;
}
export interface WordCommentReferenceInline {
