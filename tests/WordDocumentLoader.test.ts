import { WordDocumentLoader } from '../src/views/WordDocumentLoader.ts';
import type { DocxParser } from '../src/docx/DocxParser.ts';
import type { SfdtParser } from '../src/docx/SfdtParser.ts';
