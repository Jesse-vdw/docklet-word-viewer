...
import { WORD_VIEW_TYPE } from '../../src/domain/constants.ts';
import type { WordFileRepository } from '../../src/adapters/io/WordFileRepository.ts';
import type { WordDocumentLoader } from '../../src/ui/views/WordDocumentLoader.ts';
import { DEFAULT_WORD_VIEWER_SETTINGS } from '../../src/settings/settings.ts';
import { WordViewerView } from '../../src/ui/views/WordViewerView.ts';
