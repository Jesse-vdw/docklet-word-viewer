#!/usr/bin/env node
/**
 * Package script: docklet-word-viewer/scripts/check-quality-scorecard.mjs.
 ...
 * Delegates check-quality-scorecard.mjs through shared runtime + plugin capabilities.
 */
