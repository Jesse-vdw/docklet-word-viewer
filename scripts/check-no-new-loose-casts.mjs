#!/usr/bin/env node
/**
 * Package script: docklet-word-viewer/scripts/check-no-new-loose-casts.mjs.
 ...
 * Delegates check-no-new-loose-casts.mjs through shared runtime + plugin capabilities.
 */
